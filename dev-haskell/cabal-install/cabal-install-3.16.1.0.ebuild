...
RDEPEND=">=dev-haskell/async-2.0:=[profile?] <dev-haskell/async-2.3:=[profile?]
	...
	>=dev-haskell/cabal-3.16.1.0:=[profile?] <dev-haskell/cabal-3.17:=[profile?]
	>=dev-haskell/cabal-install-solver-3.16.1.0:=[profile?] <dev-haskell/cabal-install-solver-3.17:=[profile?]
	>=dev-haskell/cabal-syntax-3.16.1.0:=[profile?] <dev-haskell/cabal-syntax-3.17:=[profile?]
	...
	>=dev-haskell/open-browser-0.2.1.0:=[profile?] <dev-haskell/open-browser-0.6:=[profile?]
