...
RDEPEND=">=dev-haskell/async-2.0:= <dev-haskell/async-2.3:=
	...
	>=dev-haskell/cabal-3.10:= <dev-haskell/cabal-3.11:=
	>=dev-haskell/cabal-install-solver-3.10:= <dev-haskell/cabal-install-solver-3.11:=
	>=dev-haskell/cabal-syntax-3.10:= <dev-haskell/cabal-syntax-3.11:=
