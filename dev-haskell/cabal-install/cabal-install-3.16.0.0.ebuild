...
RDEPEND=">=dev-haskell/async-2.0:=[profile?] <dev-haskell/async-2.3:=[profile?]
	...
	>=dev-haskell/cabal-3.16:=[profile?] <dev-haskell/cabal-3.17:=[profile?]
	>=dev-haskell/cabal-install-solver-3.16:=[profile?] <dev-haskell/cabal-install-solver-3.17:=[profile?]
	>=dev-haskell/cabal-syntax-3.16:=[profile?] <dev-haskell/cabal-syntax-3.17:=[profile?]
...
CABAL_CHDEPS=(
	'base >=4.13 && <4.22' 'base >=4.13 && <4.23'
	'time       >= 1.5.0.1  && < 1.15' 'time       >= 1.5.0.1  && < 1.16'
)
