...
RDEPEND="
	...
	>=dev-haskell/cabal-3.11:=[profile?] <dev-haskell/cabal-3.13:=[profile?]
	>=dev-haskell/cabal-install-solver-3.11:=[profile?] <dev-haskell/cabal-install-solver-3.13:=[profile?]
	>=dev-haskell/cabal-syntax-3.11:=[profile?] <dev-haskell/cabal-syntax-3.13:=[profile?]
