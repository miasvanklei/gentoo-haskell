...
SLOT="0/${PV}"
KEYWORDS="~amd64"
IUSE="examples executable ghc-lib +internal-bundle-fixities"

PATCHES=(
	"${FILESDIR}/${PN}-0.8.0.2-add-executable-flag.patch"
	"${FILESDIR}/ghc-9.14.2.patch"
	"${FILESDIR}/${P}-use-system-ghc.patch"
)
...
RDEPEND="
	...
	ghc-lib? (
		>=dev-haskell/ghc-lib-parser-9.13:=[profile?] <dev-haskell/ghc-lib-parser-9.15:=[profile?]
	)
	!ghc-lib? (
		=dev-lang/ghc-9.14*:=
	)
