...
RDEPEND="
	...
	>=dev-lang/ghc-9.0.2:=
	ghc-lib? (
		>=dev-haskell/ghc-lib-parser-9.14:=[profile?] <dev-haskell/ghc-lib-parser-9.15:=[profile?]
	)
	!ghc-lib? (
		>=dev-lang/ghc-9.14:= <dev-lang/ghc-9.15:=
		>=dev-haskell/ghc-lib-parser-ex-9.14:=[profile?] <dev-haskell/ghc-lib-parser-ex-9.15:=[profile?]
	)
	gpl? (
