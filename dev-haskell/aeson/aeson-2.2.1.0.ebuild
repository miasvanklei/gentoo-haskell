...
RDEPEND="
	...
	>=dev-haskell/primitive-0.7.3.0:=[profile?] <dev-haskell/primitive-0.10:=[profile?]
	...
	>=dev-haskell/th-abstraction-0.3.0.0:=[profile?] <dev-haskell/th-abstraction-0.7:=[profile?]
