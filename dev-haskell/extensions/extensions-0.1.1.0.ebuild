...
RDEPEND=">=dev-haskell/cabal-3.14:=[profile?] <dev-haskell/cabal-3.18:=[profile?]
...
CABAL_CHDEPS=(
	'base >= 4.13.0.0 && < 4.22' 'base >= 4.13.0.0 && < 4.23'
	'ghc-boot-th >= 8.8.1 && < 9.13' 'ghc-boot-th >= 8.8.1 && < 9.15'
)
